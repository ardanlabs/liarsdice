...
// returns the calculated signature has a hexadecimal string, the raw bytes of
// the data that was signed, and any error that might have occurred.
func Sign(value any, privateKey *ecdsa.PrivateKey) (signature string, data []byte, err error) {
