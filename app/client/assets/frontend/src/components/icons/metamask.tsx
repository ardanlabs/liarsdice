...
const MetamaskLogo: FC<MetamaskLogoProps> = (MetamaskLogoProps) => {
  let { width, height } = MetamaskLogoProps
  width = width ? width : '50px'
  height = height ? height : '50px'
  return (
    <svg version="1.1" id="Layer_1"
      xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height={ height } width={ width } viewBox='0 0 318.5 318.5'>
